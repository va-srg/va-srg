Специалист по работе с пространственными данными, опытом оптимизации аналитических процессов посредством автоматизации отчётности и контроля качества данных - прошел профессиональную переподготовку в сфере BI-аналитики. В своей практике комбинирую системное мышление и навыки анализа данных: от выстраивания ETL‑процессов до разработки эффективных дашбордов. Ищу возможности для профессионального роста в роли BI‑аналитика | Аналитика данных

На странице представлены проекты, выполненные в рамках курса [BI-аналитик](https://practicum.yandex.ru/bi-analyst/), а также тестовые задания
...
<div style="display: flex; justify-content: center; align-items: center; gap: 12px; margin: 20px 0; flex-wrap: wrap;">
  ...
  >
  <img
    src="https://img.shields.io/badge/Miro-D3D3D3?style=for-the-badge&logo=miro&logoColor=555555&labelColor=D3D3D3&color=D3D3D3&textColor=555555"
    alt="Miro"
    style="vertical-align: middle;"
  >
  <img
    src="https://img.shields.io/badge/Figma-D3D3D3?style=for-the-badge&logo=figma&logoColor=555555&labelColor=D3D3D3&color=D3D3D3&textColor=555555"
    alt="Figma"
    style="vertical-align: middle;"
  >
</div>
...
<div align="center">
  <img
    src="https://visitor-badge.laobi.icu/badge?page_id=va-srg.va-srg"
    alt="Счетчик посетителей"
